...
const magmar= new PokemonFireType(front="pokemons/magmarFront.png",back="pokemons/magmarBack.png",name="Magmar")
const ponyta= new PokemonFireType(front="pokemons/ponytaFront.png",back="pokemons/ponytaBack.png",name="Ponyta")
...
const buterfree= new PokemonGrassType(front="pokemons/buterfreeFront.png",back="pokemons/buterfreeBack.png",name="Buterfree")
const scyther= new PokemonGrassType(front="pokemons/scytherFront.png",back="pokemons/scyther.png",name="Scyther") 
...
const gyarados= new PokemonWaterType(front="pokemons/gyaradosFront.png",back="pokemons/gyaradosBack.png",name="Gyarados")
const psyduck= new PokemonWaterType(front="pokemons/psyduckFront.png",back="pokemons/psyduckBack.png",name="Psyduck")